...
describe("invert()", () => {
  ...
  test("new function returns negated invocation of the original function", () => {
    ...
    expect(isLessThanOrEqualTo100(10, 10, 10, 10)).toBe(
      !isBiggerThan100(10, 10, 10, 10)
    );
    expect(isLessThanOrEqualTo100(49, 49, 1, 1)).toBe(
      !isBiggerThan100(49, 49, 1, 1)
    );
    expect(isLessThanOrEqualTo100(100, 1, 1, 1)).toBe(
      !isBiggerThan100(100, 1, 1, 1)
    );
  });
});
